...
namespace blowpipemod.Content.Projectiles.HallowedBlowpipeProjectiles
{
    public class AstralSeed : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Projectile.velocity * 0, ModContent.ProjectileType<Explosion>(), Projectile.damage, 0, Main.myPlayer);
            }
            for (int d = 0; d < 15; d++)
            {
