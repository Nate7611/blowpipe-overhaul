...
{
    public class ZenithAstralSeed : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Zenith Astral Seed");
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Projectile.velocity * 0, ModContent.ProjectileType<Explosion>(), damage * 2, 0, Main.myPlayer);
            }
            for (int d = 0; d < 15; d++)
            {
